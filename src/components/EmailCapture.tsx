  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="bg-white p-8 rounded-lg shadow-xl">
        <h3 className="text-2xl font-black uppercase tracking-wider text-center mb-2">
          ALMOST THERE!
        </h3>
        ...
        <div className="mb-6">
          ...
          />
          {error && (
            <span className="text-xs text-red-600 font-medium mt-1 block">{error}</span>
          )}
        </div>
        ...
        <button
          ...
          className="w-full py-4 bg-black text-white rounded-lg font-black text-lg uppercase tracking-wider hover:text-orange-400 transition-all duration-200 transform hover:scale-105 shadow-lg"
        >
